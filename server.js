...
const db = mysql.createConnection({
  ...
  user: "root",
  password: "n2003$6",
  database: "auth_demo" // 🛠️ change to your actual database name
});
...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "nikhil.jadhav20003@gmail.com", // 🔑 replace with your Gmail
    pass: "iagpctgxfgpyahod"     // 🔑 use app password (not regular Gmail password)
  }
});
